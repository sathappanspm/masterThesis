...
\chapter{Approach}
\markright{Sathappan Muthiah \hfill Chapter 4. Approach \hfill}
\input{sections/approach}

\chapter{Experiments}
\markright{Sathappan Muthiah \hfill Chapter 5. Experiments \hfill}
\input{sections/experiments}

\chapter{Discussion}
\markright{Sathappan Muthiah \hfill Chapter 6. Discussion  \hfill}
